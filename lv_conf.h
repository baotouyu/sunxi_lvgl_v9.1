...
#define LV_USE_DRAW_SW 1
    ...
    /* LVGL v9 实际使用 LV_DRAW_LAYER_SIMPLE_BUF_SIZE；这里给半透明/图层绘制预留更大的块。 */
    #define LV_DRAW_LAYER_SIMPLE_BUF_SIZE             (2 * 1024 * 1024)  /*[bytes]*/
...
/* 保留 LVGL 参数检查的提前返回逻辑，但关闭 benchmark/触摸场景下的 check-arg 日志刷屏。 */
...
/* Enable matrix support required by LV_USE_VECTOR_GRAPHIC */
